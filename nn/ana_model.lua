...
cmd:text()
cmd:text('Options')
cmd:option('-H', 128, 'Hidden layer size')
...
cmd:option('-anaTrFeatPrefix', 'train_kfbp', 'Expects train anaphoricity features in <anaTrFeatPfx>-na-*.h5')
cmd:option('-anaDevFeatPrefix', 'dev_kfbp', 'Expects dev anaphoricity features in <anaDevFeatPfx>-na-*.h5')
cmd:option('-c0', 1, 'False positive cost')
cmd:option('-c1', 1.3, 'False negative cost')
